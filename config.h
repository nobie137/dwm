...
static const char *screenshot[] = { "flameshot", "gui", "--clipboard", NULL};
static const char *browser[] = { "firefox" };
static const char *discord[] = { "Discord" };
static const char *time[] = { "time.sh", NULL };
...
static const char *element[] = { "element-desktop" };
